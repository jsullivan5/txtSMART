...
const Home = () => {
  return (
    <article className='home-page'>
      ...
      <h2 className='home-welcome'>Welcome to <span id='home-txt-logo'>txt<span id='home-smart-logo'>SMART</span></span>!</h2>
      ...
      <h2>Submit your best texts by resending your messsage with <span className='submit-cue'>#submit</span> to get added to Texts From Last Night</h2>
    </article>
  );
}
